...
include '../connect.php';
$id  = $_GET['id'];
$sql= "SELECT * FROM tbljabatan WHERE id_jabatan = '$id'";
								    ...
								    <div class="tab-pane active" id="tab1">
								      <form class="form-horizontal" role="form" method="post" action="index.php?page=update_jabatan">
										  <div class="form-group">
										    ...
										    <div class="col-sm-10">
										      <input type="text" class="form-control" name="id_jabatan" id="id_jabatan" readonly="readonly" value="<?php echo $id_jabatan; ?>">
										    </div>
										  </div>
										  <div class="form-group">
