...
<div class="panel-heading">
  ...
  <div class="panel-body">
     ...
     function url_link($tujuan="", $nama_link="", $id="" , $Modal=""){
        ...
        if(empty($id)){
          echo "<a  class=\"btn btn-info btn-sm btn1\"data-toggle=\"modal\" data-target=\"".$Modal."\">$nama_link</a>";
        }else{
          echo "<a class=\"btn btn-danger btn-sm btn1\" data-toggle=\"modal\" data-target=\"".$Modal."\" data-id=\"".$id."\">$nama_link</a>";
        }
    }
  		...
  		?>
			<tbody>
				<tr>
					...
					<td>
          <a class="btn btn-info btn-sm btn1" data-toggle="modal" data-target="#ModalEdit" data-id="<?php echo $id ?>"> Edit </a>
                        ...
                        <div id="rootwizard">
                             <div class="navbar">
                                <div class="tab-pane active" id="tab1">
                                    <form class="form-horizontal" role="form" method="post" action="index.php?page=input_jabatan">
                   ...
                   <div class="content-box-large">
                       <div class="panel-body">
                        <div id="rootwizard">
                             <div class="navbar">
                                <div class="tab-pane active" id="tab1">
                                    <form class="form-horizontal" role="form" method="post" action="index.php?page=update_jabatan">
                                      <div class="form-group">
