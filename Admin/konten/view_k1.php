<div class="content-box-large">
  				...
  				<div class="panel-body">
					 ...
					 function url_link($tujuan="", $nama_link="", $id="" , $Modal=""){
						  ...
						  if(empty($id)){
						    echo "<a  class=\"btn btn-danger btn-sm btn1\"data-toggle=\"modal\" data-target=\"".$Modal."\">$nama_link</a>";
						  }else{
				  		...
				  		?>
							...
							<td>
								  ...
								  <a  class="btn btn-info btn-sm btn1" href="index.php?page=info_karyawan&id=<?php echo $id; ?>">Info</a>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a id = "btndlt" class="btn btn-primary" >Non Aktif</a>
          </div>
        </div>
      </div>
